...
Route::get('campaign-files/{id}/{slug?}', ['as' => 'campaign_files', 'uses' => 'CampaignsController@showFiles']);
 Route::get('download_file/{id}/files/download/{filename}', ['as'=>'download_file', 'uses' => 'CampaignsController@downloadFile']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
    ...
    Route::group(['prefix'=>'my_campaigns'], function(){
        ...
        //files
        Route::get('edit_campaign/{id}/files', ['as'=>'edit_campaign_files', 'uses' => 'FileController@index']);
        Route::post('edit_campaign/{id}/files', [ 'uses' => 'FileController@store']);
        Route::get('edit_campaign/{id}/files/update/{file_id}', ['as'=>'file_update', 'uses' => 'FileController@edit']);
        Route::post('edit_campaign/{id}/files/update/{file_id}', [ 'uses' => 'FileController@update']);
        Route::post('delete_file', ['as' => 'delete_file', 'uses' => 'FileController@destroy']);
        Route::get('edit_campaign/{id}/files/download/{filename}', ['as'=>'download_file', 'uses' => 'FileController@downloadFile']);
    ...
    Route::resource('userman','UserManagementController');
