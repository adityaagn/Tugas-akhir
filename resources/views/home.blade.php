...
@section('content')
    ...
    <div class="main-banner">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="section-title">Crowdfunding Institut Teknologi Sepuluh Nopember</h1>
                    <p class="jumbotron-sub-text">Crowdfunding dengan project creator khusus  anak ITS</p>
                    ...
                    <div class="jumbotron-button-wrap">
                       ...
                       @if(Auth::check() && Auth::user()->user_type == 'mahasiswa')
                        <a class="btn btn-lg-filled" href="{{route('dashboard')}}">Start CrowdFunding (Mahasiswa ITS Only) </a>
                        @endif
