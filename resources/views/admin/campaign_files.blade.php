                                    ...
                                    <table class="table table-bordered categories-lists">
                                        ...
                                        @foreach($files as $file)
                                            <tr>
                                                ...
                                                <td> {{ $file->filename }}  </td>
                                                <td width="100">
                                                    <a href="{{ route('file_update', [$file->campaign_id,$file->id]) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> </a>
                                                    <a href="{{ route('download_file', [$file->campaign_id,$file->filename]) }}" class="btn btn-info btn-xs"><i class="fa fa-download"></i> </a>
                                                    <a href="javascript:;" class="btn btn-danger btn-xs" data-id="{{ $file->id }}"><i class="fa fa-trash"></i> </a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </table>
